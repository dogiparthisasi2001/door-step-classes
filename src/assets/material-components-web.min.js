  ...
  return (
    ...
    (r.m = n = [
      ...
      function(t, e, n) {
        ...
        function a(t, e) {
          for (var n = [], i = 2; i < arguments.length; i++)
            n[i - 2] = arguments[i];
          (this.root_ = t),
            this.initialize.apply(this, r(n)),
      ...
      function(t, e, n) {
        ...
        function f(t) {
          ...
          return (
            ...
            (e.fgScale_ = "0"),
            (e.frame_ = { width: 0, height: 0 }),
            (e.initialSize_ = 0),
            (e.layoutFrame_ = 0),
            (e.maxRadius_ = 0),
            (e.unboundedCoords_ = { left: 0, top: 0 }),
            (e.activationState_ = e.defaultActivationState_()),
      ...
      function(t, e, n) {
        ...
        var i, r;
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ((i = e.Direction || (e.Direction = {}))[(i.RIGHT = 0)] = "RIGHT"),
          (i[(i.LEFT = 1)] = "LEFT"),
          ((r = e.EventSource || (e.EventSource = {}))[(r.PRIMARY = 0)] =
            "PRIMARY"),
          (r[(r.TRAILING = 1)] = "TRAILING"),
          (r[(r.NONE = 2)] = "NONE"),
          (e.strings = {
        ...
        var i = {
          ...
          r = {
            ...
            CHILD_ELEMENTS_TO_TOGGLE_TABINDEX:
              "\n    ." +
              (e.cssClasses = i).LIST_ITEM_CLASS +
              " button:not(:disabled),\n    ." +
              i.LIST_ITEM_CLASS +
              " a\n  ",
      ...
      function(t, e, n) {
        ...
        var u,
          l =
            ...
            (d.prototype.layout = function() {
              0 !== this.adapter_.getListItemCount() &&
                (this.adapter_.hasCheckboxAtIndex(0)
                  ? (this.isCheckboxList_ = !0)
                  : this.adapter_.hasRadioAtIndex(0) &&
                    (this.isRadioList_ = !0));
            }),
            ...
            (d.prototype.setSelectedIndex = function(t) {
              this.isIndexValid_(t) &&
                (this.isCheckboxList_
                  ? this.setCheckboxAtIndex_(t)
                  : this.isRadioList_
                  ? this.setRadioAtIndex_(t)
            ...
            (d.prototype.handleFocusOut = function(t, e) {
              var n = this;
              0 <= e && this.adapter_.setTabIndexForListItemChildren(e, "-1"),
                setTimeout(function() {
                  n.adapter_.isFocusInsideList() ||
                    n.setTabindexToFirstSelectedItem_();
                }, 0);
            }),
            (d.prototype.handleKeydown = function(t, e, n) {
              ...
              if (this.adapter_.isRootFocused())
                r || c
                  ...
                  : (s || a) && (t.preventDefault(), this.focusFirstElement());
              else {
                ...
                if (!(-1 === d && (d = n) < 0)) {
                  ...
                  if ((this.isVertical_ && s) || (!this.isVertical_ && o))
                    this.preventDefaultEvent_(t),
                      (p = this.focusNextElement(d));
                  else if ((this.isVertical_ && r) || (!this.isVertical_ && i))
                    this.preventDefaultEvent_(t),
                      (p = this.focusPrevElement(d));
                  else if (a)
                    this.preventDefaultEvent_(t),
                      (p = this.focusFirstElement());
                  else if (c)
                    this.preventDefaultEvent_(t), (p = this.focusLastElement());
                  else if ((u || l) && e) {
                    var _ = t.target;
                    if (_ && "A" === _.tagName && u) return;
                    this.preventDefaultEvent_(t),
                      this.isSelectableList_() &&
                        this.setSelectedIndexOnAction_(d),
                      this.adapter_.notifyAction(d);
                  }
                  (this.focusedItemIndex_ = d),
                    void 0 !== p &&
                      (this.setTabindexAtIndex_(p),
                      (this.focusedItemIndex_ = p));
                }
              }
            }),
            (d.prototype.handleClick = function(t, e) {
              t !== a.numbers.UNSET_INDEX &&
                (this.isSelectableList_() &&
                  this.setSelectedIndexOnAction_(t, e),
            ...
            (d.prototype.setEnabled = function(t, e) {
              this.isIndexValid_(t) &&
                (e
                  ? (this.adapter_.removeClassForElementIndex(
                      t,
                      a.cssClasses.LIST_ITEM_DISABLED_CLASS
                    ),
                    this.adapter_.setAttributeForElementIndex(
                      t,
                      a.strings.ARIA_DISABLED,
                      "false"
                    ))
            ...
            (d.prototype.setSingleSelectionAtIndex_ = function(t) {
              if (this.selectedIndex_ !== t) {
                ...
                this.useActivatedClass_ &&
                  (e = a.cssClasses.LIST_ITEM_ACTIVATED_CLASS),
                  this.selectedIndex_ !== a.numbers.UNSET_INDEX &&
                    this.adapter_.removeClassForElementIndex(
                      this.selectedIndex_,
                      e
                    ),
            ...
            (d.prototype.setTabindexAtIndex_ = function(t) {
              this.focusedItemIndex_ === a.numbers.UNSET_INDEX && 0 !== t
              ...
              this.isSelectableList_() &&
                ...
                this.selectedIndex_ !== a.numbers.UNSET_INDEX
                  ...
                  : (function(t) {
                    ...
                    0 < this.selectedIndex_.length &&
                    (t = this.selectedIndex_.reduce(function(t, e) {
                      return Math.min(t, e);
                    }))),
                this.setTabindexAtIndex_(t);
            }),
            ...
            (d.prototype.setSelectedIndexOnAction_ = function(t, e) {
              void 0 === e && (e = !0),
                this.adapter_.listItemAtIndexHasClass(
                  t,
                  a.cssClasses.LIST_ITEM_DISABLED_CLASS
                ) ||
                  (this.isCheckboxList_
                    ? this.toggleCheckboxAtIndex_(t, e)
        ...
        function d(t) {
          ...
          return (
            (e.wrapFocus_ = !1),
            (e.isVertical_ = !0),
            (e.isSingleSelectionList_ = !1),
            (e.selectedIndex_ = a.numbers.UNSET_INDEX),
            (e.focusedItemIndex_ = a.numbers.UNSET_INDEX),
            (e.useActivatedClass_ = !1),
            (e.ariaCurrentAttrValue_ = null),
            (e.isCheckboxList_ = !1),
            (e.isRadioList_ = !1),
            e
          );
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          c =
            ((s = a.MDCFoundation),
            r(u, s),
            Object.defineProperty(u, "cssClasses", {
              get: function() {
                return g.cssClasses;
              },
              enumerable: !0,
            ...
            (u.prototype.open = function() {
              ...
              this.adapter_.saveFocus(),
                this.isQuickOpen_ ||
                  this.adapter_.addClass(u.cssClasses.ANIMATING_OPEN),
                (this.animationRequestId_ = requestAnimationFrame(function() {
                  t.adapter_.addClass(u.cssClasses.OPEN),
                    ...
                    t.isQuickOpen_
                      ...
                      : (t.openAnimationEndTimerId_ = setTimeout(function() {
                          (t.openAnimationEndTimerId_ = 0),
                            t.adapter_.removeClass(u.cssClasses.ANIMATING_OPEN),
                            t.adapter_.notifyOpen();
            ...
            (u.prototype.close = function(t) {
              ...
              void 0 === t && (t = !1),
                this.isQuickOpen_ ||
                  this.adapter_.addClass(u.cssClasses.ANIMATING_CLOSED),
                requestAnimationFrame(function() {
                  e.adapter_.removeClass(u.cssClasses.OPEN),
                    e.isQuickOpen_
                      ? e.adapter_.notifyClose()
                      : (e.closeAnimationEndTimerId_ = setTimeout(function() {
                          (e.closeAnimationEndTimerId_ = 0),
                            e.adapter_.removeClass(
                              u.cssClasses.ANIMATING_CLOSED
                            ),
                            e.adapter_.notifyClose();
            ...
            (u.prototype.autoPosition_ = function() {
              ...
              var e = this.getOriginCorner_(),
                ...
                l = (((t = {})[r] = o), (t[i] = s), t);
              c.width / u.width >
                g.numbers.ANCHOR_TO_MENU_SURFACE_WIDTH_RATIO && (r = "center"),
                (this.isHoistedElement_ || this.isFixedPosition_) &&
                  this.adjustPositionForHoistedElement_(l),
                this.adapter_.setTransformOrigin(r + " " + i),
            ...
            (u.prototype.getOriginCorner_ = function() {
              var t = g.Corner.TOP_LEFT,
                ...
                s = o
                  ? n.top + i.height + this.anchorMargin_.bottom
                  : n.top + this.anchorMargin_.top,
                a = o
                  ? n.bottom - this.anchorMargin_.bottom
                  : n.bottom + i.height - this.anchorMargin_.top,
                c = r.height - s,
                u = r.height - a;
              ...
              var l = this.adapter_.isRtl(),
                ...
                _ = (p && !l) || (!p && d && l),
                f = _
                  ? n.left + i.width + this.anchorMargin_.right
                  : n.left + this.anchorMargin_.left,
                h = _
                  ? n.right - this.anchorMargin_.right
                  : n.right + i.width - this.anchorMargin_.left,
                y = r.width - f,
                C = r.width - h;
              return (
                ((y < 0 && _ && l) || (p && !_ && y < 0) || (0 < C && y < C)) &&
                  (t = this.setBit_(t, g.CornerBit.RIGHT)),
                t
              );
            }),
            (u.prototype.getMenuSurfaceMaxHeight_ = function(t) {
              ...
              return (
                i
                  ? ((n = e.top + this.anchorMargin_.top - o),
                    r || (n += this.measurements_.anchorSize.height))
                  : ((n =
                      e.bottom -
                      this.anchorMargin_.bottom +
                      this.measurements_.anchorSize.height -
                      o),
                    r && (n -= this.measurements_.anchorSize.height)),
                n
              );
            ...
            (u.prototype.getHorizontalOriginOffset_ = function(t) {
              ...
              if (n) {
                var r = i
                  ? e.width - this.anchorMargin_.left
                  : this.anchorMargin_.right;
                return this.isHoistedElement_ || this.isFixedPosition_
                  ? r -
                      (this.measurements_.viewportSize.width -
                        this.measurements_.bodySize.width)
                  : r;
              }
              return i
                ? e.width - this.anchorMargin_.right
            ...
            (u.prototype.getVerticalOriginOffset_ = function(t) {
              ...
              return n
                ? i
                  ? e.height - this.anchorMargin_.top
                  : -this.anchorMargin_.bottom
                : i
                ? e.height + this.anchorMargin_.bottom
                : this.anchorMargin_.top;
            }),
            (u.prototype.adjustPositionForHoistedElement_ = function(t) {
              var e,
                n,
                i = this.measurements_,
                r = i.windowScroll,
        ...
        function u(t) {
          ...
          return (
            (e.isOpen_ = !1),
            (e.isQuickOpen_ = !1),
            (e.isHoistedElement_ = !1),
            (e.isFixedPosition_ = !1),
            (e.openAnimationEndTimerId_ = 0),
            (e.closeAnimationEndTimerId_ = 0),
            (e.animationRequestId_ = 0),
            (e.anchorCorner_ = g.Corner.TOP_START),
            (e.anchorMargin_ = { top: 0, right: 0, bottom: 0, left: 0 }),
            (e.position_ = { x: 0, y: 0 }),
            e
          );
        }
        ...
        var s,
          ...
          l =
            ...
            (d.prototype.handleInteraction = function(t) {
              this.shouldHandleInteraction_(t) &&
                (this.adapter_.notifyInteraction(), this.focusPrimaryAction_());
            }),
            (d.prototype.handleTransitionEnd = function(t) {
              var e = this,
                n = this.adapter_.eventTargetHasClass(
                  t.target,
                  c.cssClasses.CHIP_EXIT
                ),
              ...
              if (n && r) {
                ...
                requestAnimationFrame(function() {
                  e.adapter_.setStyleProperty("width", o),
                ...
                (n && i && (this.removeFocus_(), this.adapter_.notifyRemoval()),
                r)
              ) {
                var s =
                    ...
                    ) && this.adapter_.hasClass(c.cssClasses.SELECTED),
                  a =
                    this.adapter_.eventTargetHasClass(
                      t.target,
                      c.cssClasses.CHECKMARK
                    ) && !this.adapter_.hasClass(c.cssClasses.SELECTED);
                return s
            ...
            (d.prototype.handleKeydown = function(t) {
              ...
              var e = t.key;
              c.navigationKeys.has(e) &&
                (t.preventDefault(), this.focusNextAction_(t));
            }),
            (d.prototype.removeFocus = function() {
              this.adapter_.setPrimaryActionAttr(c.strings.TAB_INDEX, "-1"),
                this.adapter_.setTrailingActionAttr(c.strings.TAB_INDEX, "-1");
            }),
            ...
            (d.prototype.focusNextAction_ = function(t) {
              ...
              if (!c.jumpChipKeys.has(e) && n)
                return r === c.EventSource.PRIMARY && i === c.Direction.RIGHT
                  ? this.focusTrailingAction_()
                  : r === c.EventSource.TRAILING && i === c.Direction.LEFT
                  ? this.focusPrimaryAction_()
                  : void this.adapter_.notifyNavigation(e, c.EventSource.NONE);
              this.adapter_.notifyNavigation(e, r);
            }),
            (d.prototype.getEvtSource_ = function(t) {
              return this.adapter_.eventTargetHasClass(
                t.target,
                c.cssClasses.PRIMARY_ACTION
              )
                ? c.EventSource.PRIMARY
                : this.adapter_.eventTargetHasClass(
                    t.target,
                    c.cssClasses.TRAILING_ACTION
                  )
                ? c.EventSource.TRAILING
                : c.EventSource.NONE;
            }),
            (d.prototype.getDirection_ = function(t) {
              var e = this.adapter_.isRTL();
              return (t === c.strings.ARROW_LEFT_KEY && !e) ||
                (t === c.strings.ARROW_RIGHT_KEY && e)
                ? c.Direction.LEFT
                : c.Direction.RIGHT;
            }),
            (d.prototype.focusPrimaryAction_ = function() {
              this.adapter_.setPrimaryActionAttr(c.strings.TAB_INDEX, "0"),
                this.adapter_.focusPrimaryAction(),
                this.adapter_.setTrailingActionAttr(c.strings.TAB_INDEX, "-1");
            }),
            (d.prototype.focusTrailingAction_ = function() {
              this.adapter_.setTrailingActionAttr(c.strings.TAB_INDEX, "0"),
            ...
            (d.prototype.shouldHandleInteraction_ = function(t) {
              ...
              var e = t;
              return (
                e.key === c.strings.ENTER_KEY ||
                e.key === c.strings.SPACEBAR_KEY
              );
            }),
            (d.prototype.shouldRemoveChip_ = function(t) {
              return (
                this.adapter_.hasClass(c.cssClasses.DELETABLE) &&
                (t.key === c.strings.BACKSPACE_KEY ||
                  t.key === c.strings.DELETE_KEY)
              );
            }),
            (d.prototype.setSelected_ = function(t) {
              t
                ? (this.adapter_.addClass(c.cssClasses.SELECTED),
                  this.adapter_.setPrimaryActionAttr(
                    c.strings.ARIA_CHECKED,
                    "true"
                  ))
                : (this.adapter_.removeClass(c.cssClasses.SELECTED),
                  this.adapter_.setPrimaryActionAttr(
                    c.strings.ARIA_CHECKED,
                    "false"
                  ));
      ...
      function(t, e, n) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.strings = {
            ...
            HEADER_ROW_CHECKBOX_SELECTOR:
              "." + e.cssClasses.HEADER_ROW_CHECKBOX,
          ...
          l =
            ...
            (d.prototype.initialSyncWithDOM = function() {
              (this.handleClick_ = this.handleClickEvent_.bind(this)),
                ...
                (this.focusInEventListener_ = this.handleFocusInEvent_.bind(
                  this
                )),
                (this.focusOutEventListener_ = this.handleFocusOutEvent_.bind(
                  this
                )),
            ...
            (d.prototype.layout = function() {
              ...
              (this.vertical = t !== c.strings.ARIA_ORIENTATION_HORIZONTAL),
                ...
                [].slice
                  .call(
                    this.root_.querySelectorAll(
                      c.strings.FOCUSABLE_CHILD_ELEMENTS
                    )
                  )
                  .forEach(function(t) {
            ...
            (d.prototype.initializeListType = function() {
              var e = this,
                ...
                i = this.root_.querySelector(
                  c.strings.ARIA_CHECKED_RADIO_SELECTOR
                );
              if (t.length) {
                var r = this.root_.querySelectorAll(
                ...
                n
                  ? (n.classList.contains(
                    ...
                    (this.selectedIndex = this.listElements.indexOf(n)))
            ...
            (d.prototype.getListItemIndex_ = function(t) {
              var e = t.target,
                n = a.closest(
                  e,
                  "." + c.cssClasses.LIST_ITEM_CLASS + ", ." + c.cssClasses.ROOT
                );
              return n && a.matches(n, "." + c.cssClasses.LIST_ITEM_CLASS)
                ? this.listElements.indexOf(n)
                : -1;
            }),
            ...
            (d.prototype.handleKeydownEvent_ = function(t) {
              ...
              this.foundation_.handleKeydown(
                t,
                n.classList.contains(c.cssClasses.LIST_ITEM_CLASS),
                e
              );
            }),
          ...
          u =
            ...
            (l.prototype.open = function() {
              ...
              this.isOpen() ||
                ...
                this.adapter_.addClass(c.cssClasses.ANIMATE),
            ...
            (l.prototype.close = function() {
              !this.isOpen() ||
                this.isOpening() ||
                this.isClosing() ||
                this.adapter_.addClass(c.cssClasses.CLOSING);
            }),
            ...
            (l.prototype.isOpening = function() {
              return (
                this.adapter_.hasClass(c.cssClasses.OPENING) ||
                this.adapter_.hasClass(c.cssClasses.ANIMATE)
              );
            }),
            ...
            (l.prototype.handleTransitionEnd = function(t) {
              var e = c.cssClasses.OPENING,
                ...
                o = c.cssClasses.ROOT;
              this.isElement_(t.target) &&
                this.adapter_.elementHasClass(t.target, o) &&
                (this.isClosing()
      ...
      function(t, e, n) {
          ...
          u =
            ...
            (l.prototype.float = function(t) {
              ...
              t
                ...
                : (this.adapter_.removeClass(n), this.adapter_.removeClass(i));
            }),
        ...
        function l(t) {
          var e = s.call(this, o({}, l.defaultAdapter, t)) || this;
          return (
            (e.shakeAnimationEndHandler_ = function() {
      ...
      function(t, e, n) {
        ...
        var o,
          ...
          l =
            ...
            (d.prototype.initialSyncWithDOM = function() {
              this.notchElement_ = this.root_.querySelector(
                c.strings.NOTCH_ELEMENT_SELECTOR
              );
              var t = this.root_.querySelector(
                "." + a.MDCFloatingLabelFoundation.cssClasses.ROOT
              );
              t
                ? ((t.style.transitionDuration = "0s"),
                  this.root_.classList.add(c.cssClasses.OUTLINE_UPGRADED),
                  requestAnimationFrame(function() {
        ...
        var i = {
          ...
          r = {
            ...
            SELECTED_ITEM_SELECTOR:
              "." + (e.cssClasses = i).SELECTED_ITEM_CLASS,
            SELECTED_TEXT_SELECTOR: ".mdc-select__selected-text",
            SELECT_ANCHOR_SELECTOR: ".mdc-select__anchor",
            VALUE_ATTR: "data-value",
          };
        e.strings = r;
        e.numbers = { LABEL_SCALE: 0.75, UNSET_INDEX: -1 };
      },
      function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 });
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.activate = function(t) {
              this.adapter_.addClass(c.cssClasses.ACTIVE),
                this.adapter_.setAttr(c.strings.ARIA_SELECTED, "true"),
                this.adapter_.setAttr(c.strings.TABINDEX, "0"),
                this.adapter_.activateIndicator(t),
                this.focusOnActivate_ && this.adapter_.focus();
            }),
            (l.prototype.deactivate = function() {
              this.isActive() &&
                (this.adapter_.removeClass(c.cssClasses.ACTIVE),
                this.adapter_.setAttr(c.strings.ARIA_SELECTED, "false"),
                this.adapter_.setAttr(c.strings.TABINDEX, "-1"),
      ...
      function(t, e, n) {
        ...
        e.numbers = { DENSE_LABEL_SCALE: 0.923, LABEL_SCALE: 0.75 };
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.setPersistent = function(t) {
              t
                ? this.adapter_.addClass(c.cssClasses.HELPER_TEXT_PERSISTENT)
            ...
            (l.prototype.setValidity = function(t) {
              ...
              n
                ? this.adapter_.setAttr(c.strings.ROLE, "alert")
                : this.adapter_.removeAttr(c.strings.ROLE),
                e || n || this.hide_();
            }),
      ...
      function(t, e, n) {
          ...
          c =
            ...
            (u.prototype.handleTargetScroll = function() {
              ...
              (this.lastScrollPosition_ = t),
                this.isCurrentlyBeingResized_ ||
                  ...
                  0 < this.currentAppBarOffsetTop_
            ...
            (u.prototype.checkForUpdate_ = function() {
              ...
              if (i) this.wasDocked_ = !1;
                ...
                if (this.isDockedShowing_ !== n)
                  return (this.isDockedShowing_ = n), !0;
              }
              return i;
            }),
        ...
        function u(t) {
          ...
          return (
            (e.wasDocked_ = !0),
            (e.isDockedShowing_ = !0),
            (e.currentAppBarOffsetTop_ = 0),
            (e.isCurrentlyBeingResized_ = !1),
            (e.resizeThrottleId_ = 0),
            (e.resizeDebounceId_ = 0),
            (e.lastScrollPosition_ = e.adapter_.getViewportScrollY()),
            (e.topAppBarHeight_ = e.adapter_.getTopAppBarHeight()),
            e
          );
        }
            ...
            (y.prototype.createRipple_ = function() {
              var n = this,
                t = o({}, d.MDCRipple.createAdapter(this), {
                  deregisterInteractionHandler: function(t, e) {
                    return n.nativeControl_.removeEventListener(
                      t,
                      e,
                      u.applyPassive()
                    );
                  ...
                  registerInteractionHandler: function(t, e) {
                    return n.nativeControl_.addEventListener(
                      t,
                      e,
                      u.applyPassive()
                    );
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          c =
            ((s = a.MDCFoundation),
            r(_, s),
            Object.defineProperty(_, "cssClasses", {
              get: function() {
                return p.cssClasses;
              },
              enumerable: !0,
            ...
            (_.prototype.init = function() {
              (this.currentCheckState_ = this.determineCheckState_()),
                ...
                this.adapter_.addClass(p.cssClasses.UPGRADED);
            }),
            ...
            (_.prototype.setDisabled = function(t) {
              this.adapter_.setNativeControlDisabled(t),
                t
                  ? this.adapter_.addClass(p.cssClasses.DISABLED)
                  : this.adapter_.removeClass(p.cssClasses.DISABLED);
            }),
              ...
              this.enableAnimationEndHandler_ &&
                ...
                (this.animEndLatchTimer_ = setTimeout(function() {
                  t.adapter_.removeClass(t.currentAnimationClass_),
                    (t.enableAnimationEndHandler_ = !1);
              ...
              if (this.adapter_.hasNativeControl()) {
                ...
                if (t !== e) {
                  ...
                  e === n
                    ...
                    0 < this.currentAnimationClass_.length &&
                      (clearTimeout(this.animEndLatchTimer_),
        ...
        function _(t) {
          ...
          return (
            (e.currentCheckState_ = p.strings.TRANSITION_STATE_INIT),
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          _ =
            ((s = a.MDCComponent),
            r(f, s),
            Object.defineProperty(f.prototype, "selected", {
              get: function() {
            ...
            (f.prototype.initialize = function(t) {
              ...
              void 0 === t &&
                ...
                (this.leadingIcon_ = this.root_.querySelector(
                  l.strings.LEADING_ICON_SELECTOR
                )),
                (this.trailingIcon_ = this.root_.querySelector(
                  l.strings.TRAILING_ICON_SELECTOR
                )),
                (this.checkmark_ = this.root_.querySelector(
                  l.strings.CHECKMARK_SELECTOR
                )),
                (this.primaryAction_ = this.root_.querySelector(
                  l.strings.PRIMARY_ACTION_SELECTOR
                )),
                (this.trailingAction_ = this.root_.querySelector(
                  l.strings.TRAILING_ACTION_SELECTOR
                ));
            ...
            (f.prototype.initialSyncWithDOM = function() {
              ...
              (this.handleInteraction_ = function(t) {
                ...
                this.trailingIcon_ &&
                  p.forEach(function(t) {
                    e.trailingIcon_.addEventListener(
                      t,
                      e.handleTrailingIconInteraction_
                    );
                  });
            }),
            (f.prototype.destroy = function() {
              ...
              this.ripple_.destroy(),
                ...
                this.trailingIcon_ &&
                  p.forEach(function(t) {
                    e.trailingIcon_.removeEventListener(
                      t,
                      e.handleTrailingIconInteraction_
                    );
                  }),
            ...
            (f.prototype.getDefaultFoundation = function() {
              var n = this,
                t = {
                  ...
                  getCheckmarkBoundingClientRect: function() {
                    return n.checkmark_
                      ? n.checkmark_.getBoundingClientRect()
                      : null;
                  },
                  ...
                  isRTL: function() {
                    return (
                      "rtl" ===
                      window
                        .getComputedStyle(n.root_)
                        .getPropertyValue("direction")
                    );
                  },
                  notifyInteraction: function() {
                    return n.emit(
                      l.strings.INTERACTION_EVENT,
                      { chipId: n.id },
                      !0
                    );
                  },
                  ...
                  notifyRemoval: function() {
                    n.emit(
                      l.strings.REMOVAL_EVENT,
                      { chipId: n.id, root: n.root_ },
                      !0
                    );
                  },
                  notifySelection: function(t, e) {
                    return n.emit(
                      l.strings.SELECTION_EVENT,
                  ...
                  notifyTrailingIconInteraction: function() {
                    return n.emit(
                      l.strings.TRAILING_ICON_INTERACTION_EVENT,
                      { chipId: n.id },
                      !0
                    );
                  },
        ...
        var s,
          ...
          l =
            ...
            (d.prototype.handleChipInteraction = function(t) {
              ...
              this.removeFocusFromChipsExcept_(e),
                (this.adapter_.hasClass(c.cssClasses.CHOICE) ||
                  this.adapter_.hasClass(c.cssClasses.FILTER)) &&
            ...
            (d.prototype.handleChipRemoval = function(t) {
              var e = this.adapter_.getIndexOfChipById(t);
              this.deselectAndNotifyClients_(t),
                this.adapter_.removeChipAtIndex(e);
              var n = this.adapter_.getChipListCount() - 1,
                i = Math.min(e, n);
              this.removeFocusFromChipsExcept_(i),
                this.adapter_.focusChipTrailingActionAtIndex(i);
            }),
            (d.prototype.handleChipNavigation = function(t, e, n) {
              ...
              if (-1 !== r && u.navigationKeys.has(e)) {
                var o = this.adapter_.isRTL(),
                  s =
                    (e === u.strings.ARROW_RIGHT_KEY && !o) ||
                    (e === u.strings.ARROW_LEFT_KEY && o) ||
                    e === u.strings.ARROW_DOWN_KEY,
                  a = e === u.strings.HOME_KEY,
                  c = e === u.strings.END_KEY;
                s ? r++ : a ? (r = 0) : c ? (r = i) : r--,
                  r < 0 ||
                    i < r ||
                    (this.removeFocusFromChipsExcept_(r),
                    this.focusChipAction_(r, e, n));
              }
            }),
            (d.prototype.focusChipAction_ = function(t, e, n) {
              var i = u.jumpChipKeys.has(e);
              if (i && n === u.EventSource.PRIMARY)
                return this.adapter_.focusChipPrimaryActionAtIndex(t);
              if (i && n === u.EventSource.TRAILING)
                return this.adapter_.focusChipTrailingActionAtIndex(t);
              var r = this.getDirection_(e);
              return r === u.Direction.LEFT
                ? this.adapter_.focusChipTrailingActionAtIndex(t)
                : r === u.Direction.RIGHT
                ? this.adapter_.focusChipPrimaryActionAtIndex(t)
                : void 0;
            }),
            (d.prototype.getDirection_ = function(t) {
              var e = this.adapter_.isRTL();
              return (t === u.strings.ARROW_LEFT_KEY && !e) ||
                (t === u.strings.ARROW_RIGHT_KEY && e)
                ? u.Direction.LEFT
                : u.Direction.RIGHT;
            }),
            ...
            (d.prototype.toggleSelect_ = function(t) {
              0 <= this.selectedChipIds_.indexOf(t)
                ? this.deselectAndNotifyClients_(t)
                : this.selectAndNotifyClients_(t);
            }),
            (d.prototype.removeFocusFromChipsExcept_ = function(t) {
              for (var e = this.adapter_.getChipListCount(), n = 0; n < e; n++)
                n !== t && this.adapter_.removeFocusFromChipAtIndex(n);
            }),
            ...
            (d.prototype.select_ = function(t, e) {
              if (!(0 <= this.selectedChipIds_.indexOf(t))) {
                if (
                  this.adapter_.hasClass(c.cssClasses.CHOICE) &&
                  0 < this.selectedChipIds_.length
                ) {
        ...
        var c,
          ...
          d =
            ...
            (p.prototype.layout = function() {
              this.adapter_.isRowsSelectable() &&
            ...
            (p.prototype.layoutAsync = function() {
              return s(this, void 0, void 0, function() {
                return a(this, function(t) {
                  switch (t.label) {
                    case 0:
                      return this.adapter_.isRowsSelectable()
                        ? [4, this.adapter_.registerHeaderRowCheckbox()]
                        : [3, 3];
                    case 1:
                      return (
            ...
            (p.prototype.setSelectedRowIds = function(t) {
              for (var e = 0; e < this.adapter_.getRowCount(); e++) {
                var n = this.adapter_.getRowIdAtIndex(e),
                  i = !1;
                n && 0 <= t.indexOf(n) && (i = !0),
                  this.adapter_.setRowCheckboxCheckedAtIndex(e, i),
                  this.selectRowAtIndex_(e, i);
              }
              this.setHeaderRowCheckboxState_();
            }),
            (p.prototype.getSelectedRowIds = function() {
              for (var t = [], e = 0; e < this.adapter_.getRowCount(); e++)
                this.adapter_.isCheckboxAtRowIndexChecked(e) &&
                  t.push(this.adapter_.getRowIdAtIndex(e));
              return t;
            }),
            (p.prototype.handleHeaderRowCheckboxChange = function() {
              for (
                var t = this.adapter_.isHeaderRowCheckboxChecked(), e = 0;
                e < this.adapter_.getRowCount();
                e++
              )
                this.adapter_.setRowCheckboxCheckedAtIndex(e, t),
                  this.selectRowAtIndex_(e, t);
              t
            ...
            (p.prototype.setHeaderRowCheckboxState_ = function() {
              this.adapter_.getSelectedRowCount() ===
              this.adapter_.getRowCount()
                ? (this.adapter_.setHeaderRowCheckboxChecked(!0),
                  this.adapter_.setHeaderRowCheckboxIndeterminate(!1))
                : (0 === this.adapter_.getSelectedRowCount()
                    ? this.adapter_.setHeaderRowCheckboxIndeterminate(!1)
                    : this.adapter_.setHeaderRowCheckboxIndeterminate(!0),
                  this.adapter_.setHeaderRowCheckboxChecked(!1));
            }),
            (p.prototype.selectRowAtIndex_ = function(t, e) {
              e
                ? (this.adapter_.addClassAtRowIndex(
                    t,
                ...
                : (this.adapter_.removeClassAtRowIndex(
                    t,
                    l.cssClasses.ROW_SELECTED
                  ),
                  this.adapter_.setAttributeAtRowIndex(
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.init = function() {
              this.adapter_.hasClass(c.cssClasses.STACKED) &&
                this.setAutoStackButtons(!1);
            }),
            (l.prototype.destroy = function() {
              this.isOpen_ && this.close(c.strings.DESTROY_ACTION),
            ...
            (l.prototype.open = function() {
              ...
              (this.isOpen_ = !0),
                ...
                this.adapter_.addClass(c.cssClasses.OPENING),
                this.runNextAnimationFrame_(function() {
                  t.adapter_.addClass(c.cssClasses.OPEN),
                    t.adapter_.addBodyClass(c.cssClasses.SCROLL_LOCK),
                    t.layout(),
            ...
            (l.prototype.close = function(t) {
              ...
              void 0 === t && (t = ""),
                this.isOpen_ &&
                  ...
                  this.adapter_.removeBodyClass(c.cssClasses.SCROLL_LOCK),
                  cancelAnimationFrame(this.animationFrame_),
            ...
            (l.prototype.handleKeydown = function(t) {
              ...
              if (e && !this.adapter_.getActionFromEvent(t)) {
                var n = !this.adapter_.eventTargetMatches(
                  t.target,
                  c.strings.SUPPRESS_DEFAULT_PRESS_SELECTOR
                );
            ...
            (l.prototype.handleAnimationTimerEnd_ = function() {
              (this.animationTimer_ = 0),
                this.adapter_.removeClass(c.cssClasses.OPENING),
                this.adapter_.removeClass(c.cssClasses.CLOSING);
            }),
            (l.prototype.runNextAnimationFrame_ = function(t) {
              var e = this;
              cancelAnimationFrame(this.animationFrame_),
            ...
            (l.prototype.detectStackedButtons_ = function() {
              ...
              t && this.adapter_.addClass(c.cssClasses.STACKED),
                t !== this.areButtonsStacked_ &&
                  (this.adapter_.reverseButtons(),
                  (this.areButtonsStacked_ = t));
            }),
            (l.prototype.detectScrollableContent_ = function() {
              this.adapter_.removeClass(c.cssClasses.SCROLLABLE),
                this.adapter_.isContentScrollable() &&
                  this.adapter_.addClass(c.cssClasses.SCROLLABLE);
            }),
            l);
        function l(t) {
          var e = s.call(this, o({}, l.defaultAdapter, t)) || this;
          return (
            ...
            (e.animationTimer_ = 0),
            (e.layoutFrame_ = 0),
            (e.escapeKeyAction_ = c.strings.CLOSE_ACTION),
            (e.scrimClickAction_ = c.strings.CLOSE_ACTION),
            (e.autoStackButtons_ = !0),
            (e.areButtonsStacked_ = !1),
            e
          );
        }
      ...
      function(t, e, n) {
          ...
          v =
            ((i = []),
            {
              ...
              deactivateTrap: function(t) {
                var e = i.indexOf(t);
                -1 !== e && i.splice(e, 1),
                  0 < i.length && i[i.length - 1].unpause();
              },
            });
        function E(t) {
        ...
        t.exports = function(t, e) {
          var i = document,
            ...
            r = m({ returnFocusOnDeactivate: !0, escapeDeactivates: !0 }, e),
            o = {
          ...
          function c() {
            if (o.active)
              return (
                ...
                i.addEventListener("focusin", _, !0),
                ...
                i.addEventListener("click", h, { capture: !0, passive: !1 }),
            ...
            if (
              !(t =
                null !== l("initialFocus")
                  ...
                  ? i.activeElement
                  : o.firstTabbableNode || l("fallbackFocus"))
            )
              throw new Error(
          ...
          function p(t) {
            n.contains(t.target) ||
              (r.clickOutsideDeactivates
                ? a({ returnFocus: !g.isFocusable(t.target) })
                : t.preventDefault());
          }
          function _(t) {
            n.contains(t.target) ||
              ...
              C(o.mostRecentlyFocusedNode || d()));
          }
          function f(t) {
            if (
              !1 !== r.escapeDeactivates &&
              (function(t) {
                return (
            ...
            !(function(t) {
              ...
              (function(t) {
                if ((y(), t.shiftKey && t.target === o.firstTabbableNode))
                  return t.preventDefault(), C(o.lastTabbableNode);
                if (!t.shiftKey && t.target === o.lastTabbableNode)
                  t.preventDefault(), C(o.firstTabbableNode);
              })(t);
          }
          function h(t) {
            r.clickOutsideDeactivates ||
          ...
          function y() {
            var t = g(n);
            (o.firstTabbableNode = t[0] || d()),
              (o.lastTabbableNode = t[t.length - 1] || d());
          }
          function C(t) {
            t !== i.activeElement &&
              (t && t.focus
                ? (t.focus(),
                  ...
                  })((o.mostRecentlyFocusedNode = t)) && t.select())
                : C(d()));
          }
        };
      },
      ...
      function(t, e, n) {
        ...
        function l(t) {
          var e = s.call(this, o({}, l.defaultAdapter, t)) || this;
          return (
            (e.resizeFrame_ = 0), (e.resizeHandler_ = e.alignCenter.bind(e)), e
          );
        }
          ...
          u =
            ...
            (l.prototype.toggle = function(t) {
              void 0 === t && (t = !this.isOn()),
                t
                  ? this.adapter_.addClass(c.cssClasses.ICON_BUTTON_ON)
                  : this.adapter_.removeClass(c.cssClasses.ICON_BUTTON_ON),
                this.adapter_.setAttr(c.strings.ARIA_PRESSED, "" + t);
            }),
            l);
        function l(t) {
          return s.call(this, o({}, l.defaultAdapter, t)) || this;
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.activate = function() {
              this.adapter_.removeClass(c.cssClasses.LINE_RIPPLE_DEACTIVATING),
                this.adapter_.addClass(c.cssClasses.LINE_RIPPLE_ACTIVE);
            }),
            ...
            (l.prototype.handleTransitionEnd = function(t) {
              ...
              "opacity" === t.propertyName &&
                e &&
                (this.adapter_.removeClass(c.cssClasses.LINE_RIPPLE_ACTIVE),
                this.adapter_.removeClass(
                  c.cssClasses.LINE_RIPPLE_DEACTIVATING
                ));
            }),
        ...
        function l(t) {
          var e = s.call(this, o({}, l.defaultAdapter, t)) || this;
          return (
            (e.transitionEndHandler_ = function(t) {
        ...
        var s,
          ...
          l =
            ...
            (d.prototype.init = function() {
              (this.isDeterminate_ = !this.adapter_.hasClass(
                u.cssClasses.INDETERMINATE_CLASS
              )),
                (this.isReversed_ = this.adapter_.hasClass(
                  u.cssClasses.REVERSED_CLASS
                )),
                (this.progress_ = 0),
                (this.buffer_ = 1);
            }),
            (d.prototype.setDeterminate = function(t) {
              (this.isDeterminate_ = t),
                this.isDeterminate_
                  ? (this.adapter_.removeClass(
                      u.cssClasses.INDETERMINATE_CLASS
                    ),
                  ...
                  : (this.isReversed_ &&
                      (this.adapter_.removeClass(u.cssClasses.REVERSED_CLASS),
                      this.adapter_.forceLayout(),
                      this.adapter_.addClass(u.cssClasses.REVERSED_CLASS)),
                    this.adapter_.addClass(u.cssClasses.INDETERMINATE_CLASS),
            ...
            (d.prototype.setProgress = function(t) {
              (this.progress_ = t),
                this.isDeterminate_ &&
                  this.setScale_(this.adapter_.getPrimaryBar(), t);
            }),
            (d.prototype.setBuffer = function(t) {
              (this.buffer_ = t),
                this.isDeterminate_ &&
                  this.setScale_(this.adapter_.getBuffer(), t);
            }),
            (d.prototype.setReverse = function(t) {
              (this.isReversed_ = t),
                this.isDeterminate_ ||
                  (this.adapter_.removeClass(u.cssClasses.INDETERMINATE_CLASS),
                  this.adapter_.forceLayout(),
                  this.adapter_.addClass(u.cssClasses.INDETERMINATE_CLASS)),
                this.isReversed_
                  ? this.adapter_.addClass(u.cssClasses.REVERSED_CLASS)
            ...
            (d.prototype.setScale_ = function(t, e) {
              if (t) {
                ...
                this.adapter_.setStyle(
                  t,
                  a.getCorrectPropertyName(window, "transform"),
                  n
                );
              }
            }),
        ...
        var s,
          ...
          d =
            ...
            (p.prototype.initialSyncWithDOM = function() {
              ...
              (this.anchorElement =
                t && t.classList.contains(c.cssClasses.ANCHOR) ? t : null),
                this.root_.classList.contains(c.cssClasses.FIXED) &&
                ...
                this.listen("keydown", this.handleKeydown_),
                this.listen(
                  c.strings.OPENED_EVENT,
                  this.registerBodyClickListener_
                ),
                this.listen(
                  c.strings.CLOSED_EVENT,
            ...
            (p.prototype.setFixedPosition = function(t) {
              t
                ? this.root_.classList.add(c.cssClasses.FIXED)
                : this.root_.classList.remove(c.cssClasses.FIXED),
            ...
            (p.prototype.getDefaultFoundation = function() {
              var n = this,
                t = {
                  ...
                  notifyClose: function() {
                    return n.emit(
                      u.MDCMenuSurfaceFoundation.strings.CLOSED_EVENT,
                      {}
                    );
                  },
                  notifyOpen: function() {
                    return n.emit(
                      u.MDCMenuSurfaceFoundation.strings.OPENED_EVENT,
                      {}
                    );
                  },
                  ...
                  isRtl: function() {
                    return (
                      "rtl" ===
                      getComputedStyle(n.root_).getPropertyValue("direction")
                    );
                  },
                  ...
                  restoreFocus: function() {
                    n.root_.contains(document.activeElement) &&
                      n.previousFocus_ &&
                      n.previousFocus_.focus &&
                      n.previousFocus_.focus();
                  },
                  getInnerDimensions: function() {
                    return {
                  ...
                  setPosition: function(t) {
                    (n.root_.style.left = "left" in t ? t.left + "px" : ""),
                      (n.root_.style.right =
                        "right" in t ? t.right + "px" : ""),
                      (n.root_.style.top = "top" in t ? t.top + "px" : ""),
                      (n.root_.style.bottom =
                        "bottom" in t ? t.bottom + "px" : "");
                  },
        ...
        var o,
          ...
          f =
            ...
            (h.prototype.initialSyncWithDOM = function() {
              ...
              t
                ? ((this.list_ = this.listFactory_(t)),
                  (this.list_.wrapFocus = !0))
                : (this.list_ = null),
                (this.handleKeydown_ = function(t) {
                  return e.foundation_.handleKeydown(t);
                }),
                (this.handleItemAction_ = function(t) {
                  return e.foundation_.handleItemAction(
                    e.items[t.detail.index]
                  );
                }),
                ...
                this.menuSurface_.listen(
                  d.MDCMenuSurfaceFoundation.strings.OPENED_EVENT,
                  this.handleMenuSurfaceOpened_
                ),
                this.listen("keydown", this.handleKeydown_),
                this.listen(
                  u.MDCListFoundation.strings.ACTION_EVENT,
              ...
              var i = this,
                t = {
                  ...
                  focusListRoot: function() {
                    return i.root_
                      .querySelector(p.strings.LIST_SELECTOR)
                      .focus();
                  },
                  isSelectableItemAtIndex: function(t) {
                    return !!a.closest(
                      i.items[t],
                      "." + p.cssClasses.MENU_SELECTION_GROUP
                    );
                  },
                  getSelectedSiblingOfItemAtIndex: function(t) {
                    var e = a
                      ...
                      .querySelector(
                        "." + p.cssClasses.MENU_SELECTED_LIST_ITEM
                      );
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          d =
            ...
            (p.prototype.handleItemAction = function(e) {
              ...
              t < 0 ||
                (this.adapter_.notifySelected({ index: t }),
                this.adapter_.closeSurface(),
                (this.closeAnimationEndTimerId_ = setTimeout(function() {
                  var t = n.adapter_.getElementIndex(e);
                  n.adapter_.isSelectableItemAtIndex(t) &&
              ...
              switch (this.defaultFocusState_) {
                ...
                case l.DefaultFocusState.LAST_ITEM:
                  this.adapter_.focusItemAtIndex(
                    this.adapter_.getMenuItemCount() - 1
                  );
                  break;
            ...
            (p.prototype.setSelectedIndex = function(t) {
              ...
              0 <= e &&
                ...
                this.adapter_.addClassToElementAtIndex(
                  t,
                  l.cssClasses.MENU_SELECTED_LIST_ITEM
                ),
        ...
        function p(t) {
          ...
          return (
            (e.closeAnimationEndTimerId_ = 0),
            (e.defaultFocusState_ = l.DefaultFocusState.LIST_ROOT),
            e
          );
        }
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          l =
            ...
            (d.prototype.setSelectedIndex = function(t, e) {
              if (
                (void 0 === e && (e = !1),
                !(t >= this.adapter_.getMenuItemCount()))
              ) {
                var n = this.selectedIndex_;
                (this.selectedIndex_ = t),
                  this.selectedIndex_ === u.numbers.UNSET_INDEX
                    ? this.adapter_.setSelectedText("")
                    : this.adapter_.setSelectedText(
                        this.adapter_
                          .getMenuItemTextAtIndex(this.selectedIndex_)
                          .trim()
                      ),
                  n !== u.numbers.UNSET_INDEX &&
                    (this.adapter_.removeClassAtIndex(
                      n,
                      u.cssClasses.SELECTED_ITEM_CLASS
                    ),
                    this.adapter_.removeAttributeAtIndex(
                      n,
                      u.strings.ARIA_SELECTED_ATTR
                    )),
                  this.selectedIndex_ !== u.numbers.UNSET_INDEX &&
            ...
            (d.prototype.getValue = function() {
              ...
              return (
                (t && this.adapter_.getMenuItemAttr(t, u.strings.VALUE_ATTR)) ||
                ""
              );
            }),
            ...
            (d.prototype.setDisabled = function(t) {
              (this.disabled_ = t),
                this.disabled_
                  ? (this.adapter_.addClass(u.cssClasses.DISABLED),
                    this.adapter_.closeMenu())
                  : this.adapter_.removeClass(u.cssClasses.DISABLED),
                this.leadingIcon_ &&
                  this.leadingIcon_.setDisabled(this.disabled_),
                this.adapter_.setSelectedTextAttr(
                  "tabindex",
                  this.disabled_ ? "-1" : "0"
                ),
                this.adapter_.setSelectedTextAttr(
                  "aria-disabled",
                  this.disabled_.toString()
                );
            }),
            ...
            (d.prototype.handleMenuClosed = function() {
              this.adapter_.removeClass(u.cssClasses.ACTIVATED),
                (this.isMenuOpen_ = !1),
                this.adapter_.setSelectedTextAttr("aria-expanded", "false"),
                this.adapter_.isSelectedTextFocused() || this.blur_();
            }),
            (d.prototype.handleChange = function() {
              this.updateLabel_(),
                this.adapter_.notifyChange(this.getValue()),
                this.adapter_.hasClass(u.cssClasses.REQUIRED) &&
            ...
            (d.prototype.handleFocus = function() {
              this.adapter_.addClass(u.cssClasses.FOCUSED),
                this.adapter_.hasLabel() &&
                  (this.adapter_.floatLabel(!0), this.notchOutline(!0)),
            ...
            (d.prototype.handleClick = function(t) {
              this.isMenuOpen_ ||
                (this.adapter_.setRippleCenter(t),
            ...
            (d.prototype.handleKeydown = function(t) {
              if (!this.isMenuOpen_) {
                ...
                this.adapter_.hasClass(u.cssClasses.FOCUSED) &&
                  (e || n || i || r) &&
                  (this.adapter_.openMenu(),
                  (this.isMenuOpen_ = !0),
                  this.adapter_.setSelectedTextAttr("aria-expanded", "true"),
            ...
            (d.prototype.setValid = function(t) {
              this.adapter_.setSelectedTextAttr(
                ...
                t
                  ? this.adapter_.removeClass(u.cssClasses.INVALID)
                  : this.adapter_.addClass(u.cssClasses.INVALID);
            }),
            (d.prototype.isValid = function() {
              return (
                !(
                  this.adapter_.hasClass(u.cssClasses.REQUIRED) &&
                  !this.adapter_.hasClass(u.cssClasses.DISABLED)
                ) ||
                (this.selectedIndex_ !== u.numbers.UNSET_INDEX &&
                  (0 !== this.selectedIndex_ || Boolean(this.getValue())))
              );
            }),
            (d.prototype.setRequired = function(t) {
              t
                ? this.adapter_.addClass(u.cssClasses.REQUIRED)
                : this.adapter_.removeClass(u.cssClasses.REQUIRED),
                this.adapter_.setSelectedTextAttr(
                  "aria-required",
                  t.toString()
                );
            ...
            (d.prototype.getRequired = function() {
              return (
                "true" === this.adapter_.getSelectedTextAttr("aria-required")
              );
            }),
            (d.prototype.init = function() {
              var t = this.adapter_.getAnchorElement();
              t &&
                (this.adapter_.setMenuAnchorElement(t),
                this.adapter_.setMenuAnchorCorner(c.Corner.BOTTOM_START)),
                this.adapter_.setMenuWrapFocus(!1);
              var e = this.getValue();
            ...
            (d.prototype.blur_ = function() {
              this.adapter_.removeClass(u.cssClasses.FOCUSED),
                this.updateLabel_(),
        ...
        function d(t, e) {
          ...
          return (
            (n.selectedIndex_ = u.numbers.UNSET_INDEX),
            (n.disabled_ = !1),
            (n.isMenuOpen_ = !1),
            (n.leadingIcon_ = e.leadingIcon),
            (n.helperText_ = e.helperText),
            (n.menuItemValues_ = n.adapter_.getMenuItemValues()),
            n
          );
        }
              ...
              this.savedTabIndex_ &&
                (t
                  ...
                  : (this.adapter_.setAttr("tabindex", this.savedTabIndex_),
                    this.adapter_.setAttr("role", c.strings.ICON_ROLE)));
            }),
      ...
      function(t, e, n) {
          ...
          E =
            ...
            (b.prototype.init = function() {
              ...
              (this.isDiscrete_ = this.adapter_.hasClass(
                u.cssClasses.IS_DISCRETE
              )),
                (this.hasTrackMarker_ = this.adapter_.hasClass(
                  u.cssClasses.HAS_TRACK_MARKER
                )),
                l.forEach(function(t) {
                  e.adapter_.registerInteractionHandler(
                    t,
            ...
            (b.prototype.setDisabled = function(t) {
              (this.disabled_ = t),
                this.toggleClass_(u.cssClasses.DISABLED, this.disabled_),
                this.disabled_
                  ? ((this.savedTabIndex_ = this.adapter_.getTabIndex()),
                    this.adapter_.setAttribute(u.strings.ARIA_DISABLED, "true"),
                    this.adapter_.removeAttribute("tabindex"))
                  : (this.adapter_.removeAttribute(u.strings.ARIA_DISABLED),
            ...
            (b.prototype.handleDown_ = function(t) {
              ...
              if (!this.disabled_) {
                ...
                var i = function(t) {
                  ...
                  e = function e() {
                    n.handleUp_(),
                      n.adapter_.deregisterBodyInteractionHandler(r, i),
                      d.forEach(function(t) {
                        return n.adapter_.deregisterBodyInteractionHandler(
                          t,
                          e
                        );
                      });
                  };
                this.adapter_.registerBodyInteractionHandler(r, i),
                  d.forEach(function(t) {
            ...
            (b.prototype.getPageX_ = function(t) {
              return t.targetTouches && 0 < t.targetTouches.length
            ...
            (b.prototype.handleKeydown_ = function(t) {
              ...
              isNaN(n) ||
                (t.preventDefault(),
                this.adapter_.addClass(u.cssClasses.FOCUS),
                this.setValue_(n, !0),
                this.adapter_.notifyChange());
            }),
            (b.prototype.getKeyId_ = function(t) {
              return t.key === f || 37 === t.keyCode
                ? f
                : t.key === h || 39 === t.keyCode
                ? h
                : t.key === y || 38 === t.keyCode
                ? y
                : t.key === _ || 40 === t.keyCode
                ? _
                : t.key === g || 36 === t.keyCode
                ? g
                : t.key === C || 35 === t.keyCode
                ? C
                : t.key === v || 33 === t.keyCode
                ? v
                : t.key === m || 34 === t.keyCode
                ? m
                : "";
            }),
            (b.prototype.getValueForKeyId_ = function(t) {
              ...
              switch (
                (!this.adapter_.isRTL() || (t !== f && t !== h) || (i = -i), t)
              ) {
                case f:
                case _:
            ...
            (b.prototype.handleBlur_ = function() {
              (this.preventFocusState_ = !1),
                this.adapter_.removeClass(u.cssClasses.FOCUS);
            }),
              ...
              this.inTransit_ &&
                ...
                requestAnimationFrame(function() {
                  e.adapter_.setThumbContainerStyleProperty(
                    o,
                    "translateX(" + r + "px) translateX(-50%)"
                  ),
                    e.adapter_.setTrackStyleProperty(o, "scaleX(" + i + ")");
                });
            }),
            (b.prototype.setActive_ = function(t) {
              (this.active_ = t),
                this.toggleClass_(u.cssClasses.ACTIVE, this.active_);
            }),
            (b.prototype.setInTransit_ = function(t) {
              (this.inTransit_ = t),
                this.toggleClass_(u.cssClasses.IN_TRANSIT, this.inTransit_);
            }),
        ...
        function b(t) {
          ...
          return (
            (e.savedTabIndex_ = NaN),
            (e.active_ = !1),
            (e.inTransit_ = !1),
            (e.isDiscrete_ = !1),
            (e.hasTrackMarker_ = !1),
            (e.handlingThumbTargetEvt_ = !1),
            (e.min_ = 0),
            (e.max_ = 100),
            (e.step_ = 0),
            (e.value_ = 0),
            (e.disabled_ = !1),
            (e.preventFocusState_ = !1),
            (e.thumbContainerPointerHandler_ = function() {
      ...
      function(t, e, n) {
          ...
          f =
            ...
            (h.prototype.destroy = function() {
              this.clearAutoDismissTimer_(),
                ...
                clearTimeout(this.animationTimer_),
                (this.animationTimer_ = 0),
                this.adapter_.removeClass(u),
                this.adapter_.removeClass(l),
                this.adapter_.removeClass(d);
            }),
        ...
        function h(t) {
          ...
          return (
            ...
            (e.animationFrame_ = 0),
            (e.animationTimer_ = 0),
            (e.autoDismissTimer_ = 0),
            (e.autoDismissTimeoutMs_ =
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.setDisabled = function(t) {
              this.adapter_.setNativeControlDisabled(t),
                t
                  ? this.adapter_.addClass(c.cssClasses.DISABLED)
                  : this.adapter_.removeClass(c.cssClasses.DISABLED);
            }),
            ...
            (l.prototype.updateCheckedStyling_ = function(t) {
              t
                ? this.adapter_.addClass(c.cssClasses.CHECKED)
                : this.adapter_.removeClass(c.cssClasses.CHECKED);
            }),
            l);
        function l(t) {
          return s.call(this, o({}, l.defaultAdapter, t)) || this;
        ...
        var s,
          ...
          p =
            ...
            (_.prototype.initialize = function() {
              (this.area_ = this.root_.querySelector(
                l.MDCTabScrollerFoundation.strings.AREA_SELECTOR
              )),
                (this.content_ = this.root_.querySelector(
                  l.MDCTabScrollerFoundation.strings.CONTENT_SELECTOR
                ));
            }),
            (_.prototype.initialSyncWithDOM = function() {
              var e = this;
        ...
        var a,
          ...
          _ =
            ...
            (f.prototype.init = function() {
              ...
              this.adapter_.setScrollAreaStyleProperty(
                "margin-bottom",
                -t + "px"
              ),
                this.adapter_.addScrollAreaClass(
            ...
            (f.prototype.handleTransitionEnd = function(t) {
              ...
              this.isAnimating_ &&
                ...
                ((this.isAnimating_ = !1),
                this.adapter_.removeClass(f.cssClasses.ANIMATING));
            }),
            ...
            (f.prototype.incrementScrollImmediate = function(t) {
              if (0 !== t) {
                ...
                0 !== e.scrollDelta &&
                  ...
                  this.adapter_.setScrollAreaScrollLeft(e.finalScrollPosition));
              }
            }),
            ...
            (f.prototype.animate_ = function(t) {
              ...
              0 !== t.scrollDelta &&
                ...
                requestAnimationFrame(function() {
                  e.adapter_.addClass(f.cssClasses.ANIMATING),
                    e.adapter_.setScrollContentStyleProperty(
                      "transform",
                      "none"
                    );
                }),
            ...
            (f.prototype.rtlScrollerFactory_ = function() {
              ...
              if (e < 0)
                return (
                  this.adapter_.setScrollAreaScrollLeft(t),
                  new d.MDCTabScrollerRTLNegative(this.adapter_)
                );
              ...
              return (
                this.adapter_.setScrollAreaScrollLeft(t),
                r === e
                  ? new p.MDCTabScrollerRTLReverse(this.adapter_)
                  : new l.MDCTabScrollerRTLDefault(this.adapter_)
              );
            }),
            (f.prototype.isRTL_ = function() {
              return (
                "rtl" === this.adapter_.getScrollContentStyleValue("direction")
              );
            }),
            f);
        function f(t) {
          ...
          p =
            ...
            (_.prototype.initialize = function(t, e) {
              ...
              var n = this.root_.querySelector(
                  d.MDCTabFoundation.strings.RIPPLE_SELECTOR
                ),
              ...
              var o = this.root_.querySelector(
                d.MDCTabFoundation.strings.TAB_INDICATOR_SELECTOR
              );
              (this.tabIndicator_ = e(o)),
                (this.content_ = this.root_.querySelector(
                  d.MDCTabFoundation.strings.CONTENT_SELECTOR
                ));
            }),
            (_.prototype.initialSyncWithDOM = function() {
              var t = this;
            ...
            (_.prototype.getDefaultFoundation = function() {
              var n = this,
                t = {
                  ...
                  notifyInteracted: function() {
                    return n.emit(
                      d.MDCTabFoundation.strings.INTERACTED_EVENT,
                      { tabId: n.id },
                      !0
                    );
                  },
        ...
        var l,
          d =
            ...
            (p.prototype.activateTab = function(t) {
              var e,
                n = this.adapter_.getPreviousActiveTabIndex();
              this.indexIsInRange_(t) &&
                t !== n &&
                (-1 !== n &&
                  (this.adapter_.deactivateTabAtIndex(n),
                  (e = this.adapter_.getTabIndicatorClientRectAtIndex(n))),
                this.adapter_.activateTabAtIndex(t, e),
            ...
            (p.prototype.handleKeyDown = function(t) {
              ...
              if (void 0 !== e)
                if (
                  ...
                  var n = this.determineTargetFromKey_(
                  ...
                  this.isActivationKey_(e)
                    ? this.adapter_.setActiveTab(i)
                    : ((n = this.determineTargetFromKey_(i, e)),
                      this.adapter_.focusTabAtIndex(n),
                      this.scrollIntoView(n));
                }
            }),
            (p.prototype.handleTabInteraction = function(t) {
              this.adapter_.setActiveTab(
                this.adapter_.getIndexOfTabById(t.detail.tabId)
              );
            }),
            (p.prototype.scrollIntoView = function(t) {
              if (this.indexIsInRange_(t))
                return 0 === t
                  ...
                  ? this.adapter_.scrollTo(
                      this.adapter_.getScrollContentWidth()
                    )
                  : this.isRTL_()
            ...
            (p.prototype.calculateScrollIncrementRTL_ = function(
              t,
              e,
              n,
              i,
            ...
            (p.prototype.findAdjacentTabIndexClosestToEdge_ = function(
              t,
              e,
              n,
              i
            ...
            (p.prototype.findAdjacentTabIndexClosestToEdgeRTL_ = function(
              t,
              e,
              n,
              i,
      ...
      function(t, e, n) {
        ...
        var s,
          ...
          d =
            ...
            (p.prototype.notchOutline = function(t) {
              if (this.adapter_.hasOutline())
                if (t) {
                  var e = this.adapter_.hasClass(c.cssClasses.DENSE)
                      ? c.numbers.DENSE_LABEL_SCALE
                      : c.numbers.LABEL_SCALE,
            ...
            (p.prototype.styleDisabled_ = function(t) {
              var e = p.cssClasses,
                ...
                i = e.INVALID;
              t
                ? (this.adapter_.addClass(n), this.adapter_.removeClass(i))
                : this.adapter_.removeClass(n),
        ...
        function p(t, e) {
          ...
          return (
            ...
            (n.leadingIcon_ = e.leadingIcon),
            (n.trailingIcon_ = e.trailingIcon),
          ...
          c =
            ...
            (u.prototype.handleTargetScroll = function() {
              this.adapter_.getViewportScrollY() <= 0
                ? this.wasScrolled_ &&
                  (this.adapter_.removeClass(s.cssClasses.FIXED_SCROLLED_CLASS),
                  (this.wasScrolled_ = !1))
                : this.wasScrolled_ ||
                  (this.adapter_.addClass(s.cssClasses.FIXED_SCROLLED_CLASS),
                  (this.wasScrolled_ = !0));
            }),
            u);
        function u() {
          ...
          c =
            ...
            (u.prototype.init = function() {
              o.prototype.init.call(this),
                0 < this.adapter_.getTotalActionItems() &&
                  this.adapter_.addClass(
                    s.cssClasses.SHORT_HAS_ACTION_ITEM_CLASS
                  ),
                this.setAlwaysCollapsed(
                  this.adapter_.hasClass(s.cssClasses.SHORT_COLLAPSED_CLASS)
                );
            }),
            ...
            (u.prototype.uncollapse_ = function() {
              this.adapter_.removeClass(s.cssClasses.SHORT_COLLAPSED_CLASS),
                (this.isCollapsed_ = !1);
            }),
            (u.prototype.collapse_ = function() {
              this.adapter_.addClass(s.cssClasses.SHORT_COLLAPSED_CLASS),
                (this.isCollapsed_ = !0);
            }),
            u);
        function u(t) {
      ...
      function(t, e, n) {
        ...
        var w = r(n(163));
        (e.topAppBar = w),
          o.default.register("MDCCheckbox", a.MDCCheckbox),
          o.default.register("MDCChip", c.MDCChip),
          o.default.register("MDCChipSet", c.MDCChipSet),
          o.default.register("MDCDataTable", u.MDCDataTable),
          o.default.register("MDCDialog", l.MDCDialog),
          o.default.register("MDCDrawer", p.MDCDrawer),
          o.default.register("MDCFloatingLabel", _.MDCFloatingLabel),
          o.default.register("MDCFormField", f.MDCFormField),
          o.default.register("MDCGridList", h.MDCGridList),
          o.default.register("MDCIconButtonToggle", y.MDCIconButtonToggle),
          o.default.register("MDCLineRipple", C.MDCLineRipple),
          o.default.register("MDCLinearProgress", g.MDCLinearProgress),
          o.default.register("MDCList", m.MDCList),
          o.default.register("MDCMenu", E.MDCMenu),
          o.default.register("MDCMenuSurface", v.MDCMenuSurface),
          o.default.register("MDCNotchedOutline", b.MDCNotchedOutline),
          o.default.register("MDCRadio", T.MDCRadio),
          o.default.register("MDCRipple", O.MDCRipple),
          o.default.register("MDCSelect", A.MDCSelect),
          o.default.register("MDCSlider", I.MDCSlider),
          o.default.register("MDCSnackbar", S.MDCSnackbar),
          o.default.register("MDCSwitch", L.MDCSwitch),
          o.default.register("MDCTabBar", R.MDCTabBar),
          o.default.register("MDCTextField", N.MDCTextField),
          o.default.register("MDCTopAppBar", w.MDCTopAppBar);
      },
      function(t, e, n) {
        "use strict";
        var d =
        ...
        var o,
          ...
          C =
            ...
            (g.prototype.initialSyncWithDOM = function() {
              ...
              this.chips_.forEach(function(t) {
                ...
                (this.handleChipSelection_ = function(t) {
                  e.foundation_.handleChipSelection(
                    t.detail.chipId,
                    t.detail.selected,
                    t.detail.shouldIgnore
                  );
                }),
                ...
                (this.handleChipNavigation_ = function(t) {
                  return e.foundation_.handleChipNavigation(
                    t.detail.chipId,
                    t.detail.key,
                    t.detail.source
                  );
                }),
                this.listen(d, this.handleChipInteraction_),
                this.listen(p, this.handleChipSelection_),
                this.listen(_, this.handleChipRemoval_),
                this.listen(f, this.handleChipNavigation_);
            }),
            (g.prototype.destroy = function() {
              this.chips_.forEach(function(t) {
                t.destroy();
              }),
                this.unlisten(d, this.handleChipInteraction_),
                this.unlisten(p, this.handleChipSelection_),
                this.unlisten(_, this.handleChipRemoval_),
                this.unlisten(f, this.handleChipNavigation_),
                o.prototype.destroy.call(this);
            }),
            (g.prototype.addChip = function(t) {
              (t.id = t.id || "mdc-chip-" + ++y),
                this.chips_.push(this.chipFactory_(t));
            }),
              ...
              var i = this,
                t = {
                  ...
                  selectChipAtIndex: function(t, e, n) {
                    0 <= t &&
                      t < i.chips_.length &&
                      i.chips_[t].setSelectedFromChipSet(e, n);
                  },
                };
            ...
            (g.prototype.instantiateChips_ = function(e) {
              return [].slice
                .call(this.root_.querySelectorAll(h))
                .map(function(t) {
          ...
          d =
            ...
            (p.prototype.initialSyncWithDOM = function() {
              ...
              (this.headerRow_ = this.root_.querySelector(
                ...
                (this.content_ = this.root_.querySelector(
                  "." + u.cssClasses.CONTENT
                )),
                (this.handleRowCheckboxChange_ = function(t) {
                  return e.foundation_.handleRowCheckboxChange(t);
                }),
                this.content_.addEventListener(
                  "change",
                  this.handleRowCheckboxChange_
                ),
                this.layout();
            }),
            (p.prototype.layout = function() {
            ...
            (p.prototype.destroy = function() {
              this.headerRow_.removeEventListener(
                ...
                this.rowCheckboxList_.forEach(function(t) {
                  return t.destroy();
                });
            }),
            (p.prototype.getDefaultFoundation = function() {
              var i = this,
                t = {
                  ...
                  getRowElements: function() {
                    return [].slice.call(
                      i.root_.querySelectorAll(u.strings.ROW_SELECTOR)
                    );
                  },
                  getRowIdAtIndex: function(t) {
                    return i
                      .getRows()
                      [t].getAttribute(u.strings.DATA_ROW_ID_ATTR);
                  },
                  getRowIndexByChildElement: function(t) {
                    return i
                      .getRows()
                      .indexOf(c.closest(t, u.strings.ROW_SELECTOR));
                  },
                  getSelectedRowCount: function() {
                    return i.root_.querySelectorAll(
                      u.strings.ROW_SELECTED_SELECTOR
                    ).length;
                  },
                  ...
                  isRowsSelectable: function() {
                    return !!i.root_.querySelector(
                      u.strings.ROW_CHECKBOX_SELECTOR
                    );
                  },
                  notifyRowSelectionChanged: function(t) {
                    i.emit(
                      u.events.ROW_SELECTION_CHANGED,
                      {
                  ...
                  registerHeaderRowCheckbox: function() {
                    ...
                    var t = i.root_.querySelector(
                      u.strings.HEADER_ROW_CHECKBOX_SELECTOR
                    );
                    i.headerRowCheckbox_ = i.checkboxFactory_(t);
                  },
                  registerRowCheckboxes: function() {
                    i.rowCheckboxList_ &&
                      i.rowCheckboxList_.forEach(function(t) {
                        return t.destroy();
                      }),
                      (i.rowCheckboxList_ = []),
                      i.getRows().forEach(function(t) {
                        var e = i.checkboxFactory_(
                          t.querySelector(u.strings.ROW_CHECKBOX_SELECTOR)
                        );
            ...
            (p.prototype.getRowIdByIndex_ = function(t) {
              return this.getRowByIndex_(t).getAttribute(
                u.strings.DATA_ROW_ID_ATTR
              );
            }),
            p);
        function p() {
        ...
        function i(t, e) {
          ...
          for (
            ...
            l((i = a[n])) &&
              (0 === (r = d(i))
                ? o.push(i)
                : s.push({ documentOrder: n, tabIndex: r, node: i }));
          return s
            .sort(p)
            .map(function(t) {
              return t.node;
        ...
        var s,
          ...
          f =
            ...
            (h.prototype.initialize = function(t) {
              var e,
                n,
                i = this.root_.querySelector(_.CONTAINER_SELECTOR);
              if (!i)
                throw new Error(
                  "Dialog component requires a " +
                    _.CONTAINER_SELECTOR +
                    " container element"
                );
              (this.container_ = i),
                (this.content_ = this.root_.querySelector(_.CONTENT_SELECTOR)),
                (this.buttons_ = [].slice.call(
                  this.root_.querySelectorAll(_.BUTTON_SELECTOR)
                )),
                (this.defaultButton_ = this.root_.querySelector(
                  "[" + _.BUTTON_DEFAULT_ATTRIBUTE + "]"
                )),
                (this.focusTrapFactory_ = t),
                (this.buttonRipples_ = []);
              try {
                for (
                  var r = a(this.buttons_), o = r.next();
                  !o.done;
                  o = r.next()
                ) {
                  var s = o.value;
            ...
            (h.prototype.initialSyncWithDOM = function() {
              var e = this;
              (this.focusTrap_ = p.createFocusTrapInstance(
                this.container_,
                ...
                (this.handleKeydown_ = this.foundation_.handleKeydown.bind(
                  this.foundation_
                )),
              ...
              (this.handleOpening_ = function() {
                ...
                this.listen("click", this.handleClick_),
                this.listen("keydown", this.handleKeydown_),
                this.listen(_.OPENING_EVENT, this.handleOpening_),
                this.listen(_.CLOSING_EVENT, this.handleClosing_);
            }),
            (h.prototype.destroy = function() {
              this.unlisten("click", this.handleClick_),
                this.unlisten("keydown", this.handleKeydown_),
                this.unlisten(_.OPENING_EVENT, this.handleOpening_),
                this.unlisten(_.CLOSING_EVENT, this.handleClosing_),
                this.handleClosing_(),
        ...
        var a,
          ...
          C =
            ...
            (g.prototype.initialize = function(t, e) {
              void 0 === t && (t = d.default),
                void 0 === e &&
                  (e = function(t) {
                    return new u.MDCList(t);
                  });
              var n = this.root_.querySelector(
                "." + l.MDCListFoundation.cssClasses.ROOT
              );
            ...
            (g.prototype.initialSyncWithDOM = function() {
              var e = this,
                t = h.MODAL,
                n = y.SCRIM_SELECTOR;
              (this.scrim_ = this.root_.parentNode.querySelector(n)),
                this.scrim_ &&
                  ...
                  (this.focusTrap_ = f.createFocusTrapInstance(
                    this.root_,
                    this.focusTrapFactory_
                  ))),
                (this.handleKeydown_ = function(t) {
            ...
            (g.prototype.destroy = function() {
              ...
              this.scrim_ &&
                ...
                this.root_.classList.contains(t) &&
                (this.scrim_.removeEventListener(
                  "click",
                  this.handleScrimClick_
                ),
                (this.open = !1));
              ...
              var e = this,
                t = {
                  ...
                  restoreFocus: function() {
                    ...
                    t &&
                      t.focus &&
                      e.root_.contains(document.activeElement) &&
                      t.focus();
                  },
                  focusActiveNavigationItem: function() {
                    var t = e.root_.querySelector(
                      "." +
                ...
                n = h.DISMISSIBLE,
                i = h.MODAL;
              if (this.root_.classList.contains(n))
                return new p.MDCDismissibleDrawerFoundation(t);
              if (this.root_.classList.contains(i))
                return new _.MDCModalDrawerFoundation(t);
              throw new Error(
            ...
            (u.prototype.getDefaultFoundation = function() {
              var n = this,
                t = {
                  ...
                  getNumberOfTiles: function() {
                    return n.root_.querySelectorAll(
                      a.MDCGridListFoundation.strings.TILE_SELECTOR
                    ).length;
                  },
                  getOffsetWidth: function() {
                    return n.root_.offsetWidth;
                  ...
                  setStyleForTilesElement: function(t, e) {
                    n.root_.querySelector(
                      a.MDCGridListFoundation.strings.TILES_SELECTOR
                    ).style[t] = e;
                  },
                };
                ...
                t = {
                  ...
                  getBuffer: function() {
                    return e.root_.querySelector(
                      a.MDCLinearProgressFoundation.strings.BUFFER_SELECTOR
                    );
                  },
                  getPrimaryBar: function() {
                    return e.root_.querySelector(
                      a.MDCLinearProgressFoundation.strings.PRIMARY_BAR_SELECTOR
                    );
                  },
                  hasClass: function(t) {
                    return e.root_.classList.contains(t);
          ...
          E =
            ...
            (b.prototype.initialize = function(t, e, n, i, r, o) {
              if (
                ...
                (this.selectAnchor_ = this.root_.querySelector(
                  C.strings.SELECT_ANCHOR_SELECTOR
                )),
                (this.selectedText_ = this.root_.querySelector(
                  C.strings.SELECTED_TEXT_SELECTOR
                )),
                !this.selectedText_)
              )
                throw new Error(
              ...
              if (this.selectedText_.hasAttribute(C.strings.ARIA_CONTROLS)) {
                var s = document.getElementById(
                  this.selectedText_.getAttribute(C.strings.ARIA_CONTROLS)
                );
              ...
              l && (this.leadingIcon_ = r(l)),
                this.root_.classList.contains(C.cssClasses.OUTLINED) ||
            ...
            (b.prototype.initialSyncWithDOM = function() {
              ...
              (this.handleChange_ = function() {
                ...
                this.menu_.listen(
                  u.strings.CLOSED_EVENT,
                  this.handleMenuClosed_
                ),
                this.menu_.listen(
                  u.strings.OPENED_EVENT,
                ...
                this.foundation_.init(),
                (this.disabled = this.root_.classList.contains(
                  C.cssClasses.DISABLED
                ));
            }),
            (b.prototype.destroy = function() {
              this.selectedText_.removeEventListener(
                ...
                this.menu_.destroy(),
                this.ripple_ && this.ripple_.destroy(),
            ...
            (b.prototype.menuSetup_ = function(t) {
              (this.menuElement_ = this.root_.querySelector(
                C.strings.MENU_SELECTOR
              )),
                (this.menu_ = t(this.menuElement_));
            }),
            (b.prototype.createRipple_ = function() {
              var n = this,
                t = o(
                  {},
                  h.MDCRipple.createAdapter({ root_: this.selectAnchor_ }),
                  {
                    registerInteractionHandler: function(t, e) {
              ...
              return new h.MDCRipple(
                this.selectAnchor_,
                new y.MDCRippleFoundation(t)
              );
            }),
            (b.prototype.getSelectAdapterMethods_ = function() {
              ...
              return {
                getSelectedMenuItem: function() {
                  return i.menuElement_.querySelector(
            ...
            (b.prototype.getNormalizedXCoordinate_ = function(t) {
              ...
              return (
                (this.isTouchEvent_(t) ? t.touches[0].clientX : t.clientX) -
                e.left
              );
            }),
      ...
      function(t, n, e) {
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
          ...
          i(e(71));
        var r = e(72);
        (n.helperTextCssClasses = r.cssClasses),
          (n.helperTextStrings = r.strings);
      },
      function(t, n, e) {
        "use strict";
        function i(t) {
          ...
          l =
            ...
            (d.prototype.initialize = function() {
              (this.thumbContainer_ = this.root_.querySelector(
                c.strings.THUMB_CONTAINER_SELECTOR
              )),
                (this.track_ = this.root_.querySelector(
                  c.strings.TRACK_SELECTOR
                )),
                (this.pinValueMarker_ = this.root_.querySelector(
                  c.strings.PIN_VALUE_MARKER_SELECTOR
                )),
                (this.trackMarkerContainer_ = this.root_.querySelector(
                  c.strings.TRACK_MARKER_CONTAINER_SELECTOR
                ));
            }),
            (d.prototype.getDefaultFoundation = function() {
              var o = this,
                t = {
                  ...
                  deregisterThumbContainerInteractionHandler: function(t, e) {
                    o.thumbContainer_.removeEventListener(
                      t,
                      e,
                      a.applyPassive()
                    );
                  ...
                  setTrackMarkers: function(t, e, n) {
                    var i = t.toLocaleString(),
                      r =
                        "linear-gradient(to right, currentColor 2px, transparent 0) 0 center / calc((100% - 2px) / ((" +
                        e.toLocaleString() +
                        " - " +
                        n.toLocaleString() +
                        ") / " +
            ...
            (d.prototype.initialSyncWithDOM = function() {
              var t = this.parseFloat_(
                  this.root_.getAttribute(c.strings.ARIA_VALUENOW),
                  this.value
                ),
                e = this.parseFloat_(
                  this.root_.getAttribute(c.strings.ARIA_VALUEMIN),
                  this.min
                ),
                n = this.parseFloat_(
                  this.root_.getAttribute(c.strings.ARIA_VALUEMAX),
                  this.max
                );
              e >= this.max
                ? ((this.max = n), (this.min = e))
                : ((this.min = e), (this.max = n)),
                (this.step = this.parseFloat_(
                  this.root_.getAttribute(c.strings.STEP_DATA_ATTR),
                  this.step
                )),
                (this.value = t),
                (this.disabled =
                  this.root_.hasAttribute(c.strings.ARIA_DISABLED) &&
                  "false" !== this.root_.getAttribute(c.strings.ARIA_DISABLED)),
        ...
        var s,
          ...
          v =
            ...
            (E.prototype.initialSyncWithDOM = function() {
              var n = this;
              (this.surfaceEl_ = this.root_.querySelector(p)),
                (this.labelEl_ = this.root_.querySelector(_)),
                (this.actionEl_ = this.root_.querySelector(f)),
                (this.handleKeyDown_ = function(t) {
                ...
                (this.handleSurfaceClick_ = function(t) {
                  var e = t.target;
                  n.isActionButton_(e)
                    ? n.foundation_.handleActionButtonClick(t)
                    : n.isActionIcon_(e) &&
                      n.foundation_.handleActionIconClick(t);
                }),
            ...
            (y.prototype.createRipple_ = function() {
              var n = this,
                ...
                e = o({}, p.MDCRipple.createAdapter(this), {
                  ...
                  deregisterInteractionHandler: function(t, e) {
                    n.nativeControl_.removeEventListener(
                      t,
                      e,
                      l.applyPassive()
                    );
          ...
          _ =
            ...
            (f.prototype.initialize = function(t, e) {
              void 0 === t &&
                ...
                (this.tabList_ = this.instantiateTabs_(t)),
                (this.tabScroller_ = this.instantiateTabScroller_(e));
            }),
            (f.prototype.initialSyncWithDOM = function() {
              var e = this;
              (this.handleTabInteraction_ = function(t) {
                ...
                this.listen(
                  u.MDCTabFoundation.strings.INTERACTED_EVENT,
        ...
        var a,
          ...
          _ =
            ...
            (f.prototype.initialize = function(t, e, n, i, r, o, s) {
              ...
              !h && p && d && (h = d.querySelector(f.ROOT_SELECTOR)),
                (this.characterCounter_ = h ? i(h) : null),
                (this.leadingIcon_ = null),
                (this.trailingIcon_ = null);
              var y = this.root_.querySelectorAll(T.strings.ICON_SELECTOR);
              0 < y.length &&
                (1 < y.length
                  ? ((this.leadingIcon_ = r(y[0])),
                    (this.trailingIcon_ = r(y[1])))
                  : this.root_.classList.contains(
                      T.cssClasses.WITH_LEADING_ICON
                    )
                  ? (this.leadingIcon_ = r(y[0]))
                  : (this.trailingIcon_ = r(y[0]))),
            ...
            (f.prototype.getFoundationMap_ = function() {
              return {
                characterCounter: this.characterCounter_
                  ? this.characterCounter_.foundation
                  : void 0,
                helperText: this.helperText_
                  ? this.helperText_.foundation
                  : void 0,
      ...
      function(t, n, e) {
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
          ...
          i(e(31));
        var r = e(93);
        (n.characterCountCssClasses = r.cssClasses),
          (n.characterCountStrings = r.strings);
      },
      function(t, n, e) {
        "use strict";
        function i(t) {
          ...
          p =
            ...
            (_.prototype.initialize = function(n) {
              void 0 === n &&
                ...
                (this.navIcon_ = this.root_.querySelector(
                  c.strings.NAVIGATION_ICON_SELECTOR
                ));
              var t = [].slice.call(
                this.root_.querySelectorAll(c.strings.ACTION_ITEM_SELECTOR)
              );
              this.navIcon_ && t.push(this.navIcon_),
                (this.iconRipples_ = t.map(function(t) {
                  var e = n(t);
            ...
            (_.prototype.initialSyncWithDOM = function() {
              (this.handleNavigationClick_ = this.foundation_.handleNavigationClick.bind(
                ...
                (this.handleWindowResize_ = this.foundation_.handleWindowResize.bind(
                  this.foundation_
                )),
                (this.handleTargetScroll_ = this.foundation_.handleTargetScroll.bind(
                  this.foundation_
                )),
                this.scrollTarget_.addEventListener(
                  "scroll",
                  this.handleTargetScroll_
                ),
                this.navIcon_ &&
                  this.navIcon_.addEventListener(
                    "click",
                    this.handleNavigationClick_
                  );
              var t = this.root_.classList.contains(c.cssClasses.FIXED_CLASS);
              this.root_.classList.contains(c.cssClasses.SHORT_CLASS) ||
                t ||
            ...
            (_.prototype.destroy = function() {
              this.iconRipples_.forEach(function(t) {
                ...
                this.scrollTarget_.removeEventListener(
                  "scroll",
                  this.handleTargetScroll_
                ),
                this.navIcon_ &&
                  this.navIcon_.removeEventListener(
                    "click",
                    this.handleNavigationClick_
                  );
              var t = this.root_.classList.contains(c.cssClasses.FIXED_CLASS);
            ...
            (_.prototype.getDefaultFoundation = function() {
              var n = this,
                t = {
                  ...
                  getTotalActionItems: function() {
                    return n.root_.querySelectorAll(
                      c.strings.ACTION_ITEM_SELECTOR
                    ).length;
                  },
                };
              return this.root_.classList.contains(c.cssClasses.SHORT_CLASS)
                ? new l.MDCShortTopAppBarFoundation(t)
                : this.root_.classList.contains(c.cssClasses.FIXED_CLASS)
                ? new u.MDCFixedTopAppBarFoundation(t)
                : new d.MDCTopAppBarFoundation(t);
            }),
            _);
        function _() {
          return (null !== o && o.apply(this, arguments)) || this;
